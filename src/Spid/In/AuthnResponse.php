...
class AuthnResponse extends AbstractAuthnResponse
{
    public function validate($xml, $hasAssertion): bool
    {
        $accepted_clock_skew_seconds = isset($this->sp->settings['accepted_clock_skew_seconds']) ?
            $this->sp->settings['accepted_clock_skew_seconds'] : 0;
